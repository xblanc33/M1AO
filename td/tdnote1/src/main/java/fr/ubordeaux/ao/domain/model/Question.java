...
public class Question {
    ...
    public Set<String> getCandidateAnswerSet() {
        return this.candidateAnswerSet;
    }

    public Set<String> getTrueAnswerSet() {
        return this.trueAnswerSet;
    }
    ...
    private void setCandidateAnswerSet(Set<String> candidateAnswerSet) {
        if (candidateAnswerSet == null) throw new QuestionExamException("cannot create question with null candidateAnswerSet");
